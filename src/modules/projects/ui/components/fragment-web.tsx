  ...
  return (
    <div className="relative flex flex-col w-full h-full">
      ...
      <Tabs defaultValue="preview" className="flex flex-col w-full h-full">
        <div className="p-2 border-b bg-sidebar flex items-center justify-between gap-x-2">
          <div className="flex items-center gap-x-2">
            ...
            <Hint text="Click to copy" side="bottom">
              <Button
                ...
                className="justify-start text-start font-normal max-w-[300px]"
              >
          ...
          <TabsList>
            <TabsTrigger value="preview" className="gap-x-1.5">
              <EyeIcon className="size-3.5" />
              Preview
            </TabsTrigger>
            <TabsTrigger value="code" className="gap-x-1.5">
