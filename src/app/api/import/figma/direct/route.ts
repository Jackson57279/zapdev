...
export async function POST(request: Request) {
  ...
  try {
    ...
    // TODO: Re-implement Figma direct import processing with new AI SDK agent
    console.warn("[figma/direct] Feature temporarily unavailable during migration");

    return NextResponse.json({
      success: true,
      importId,
      message: "Figma import queued (processing temporarily unavailable)",
    });
  } catch (error) {
